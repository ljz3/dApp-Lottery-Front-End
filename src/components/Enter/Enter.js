...
export default function Enter() {
    ...
    async function handleApprove() {
      ...
      let MOKContract = new ethers.Contract( "0xAe52aaE37B10Ef9Adcb050A54778c5Abcf1f8632" , MOKABI , signer );

      await MOKContract.approve("0x7787df0E60841c29eb0FdEb19800A7ed17Cc16d1", ethers.utils.parseEther("20"));
    }

    async function handleEnter() {
      const provider = new ethers.providers.Web3Provider(window.ethereum);
      const signer = provider.getSigner();
      let lotteryContract = new ethers.Contract( "0x7787df0E60841c29eb0FdEb19800A7ed17Cc16d1" , lotteryABI , signer );
    ...
    return(
      <div className="enterContainer">
        ...
        >
          ...
          {currentAddress !== "" && <Button variant="outlined" style={{borderColor: "black", color: 'black', backgroundColor: '#2ecc71'}} onClick={handleApprove}>Approve</Button>}
          <br/>
          {currentAddress !== "" && <Button variant="outlined" style={{borderColor: "black", color: 'black', backgroundColor: '#2ecc71'}} onClick={handleEnter}>Enter</Button>}
